   ...
   return <section className="section hero" id="hero">
      <div className="hero__body">
         <div className={`hero__title`}>
            ...
            <div className={`uppercase fade ${observerClass}`} ref={ref}  style={{transitionDelay: ".1s"}}> Mandaniaina<span className="text-primary"> Vonintsoa</span> <br></br>Fitiavana</div>
         </div>
